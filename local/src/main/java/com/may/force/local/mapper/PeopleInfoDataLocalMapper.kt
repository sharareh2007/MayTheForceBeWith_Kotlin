...
class PeopleInfoDataLocalMapper @Inject constructor(): Mapper<PeopleInfoData, PeopleInfoLocal> {

    override fun from(e: PeopleInfoLocal): PeopleInfoData {
    ...
    override fun to(t: PeopleInfoData): PeopleInfoLocal {
        return PeopleInfoLocal(
            name = t.name,
            height = t.height,
            mass = t.mass,
